...
ActiveRecord::Schema.define(version: 2019_01_31_145453) do
  ...
  create_table "join_table_doctors_specialties", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "doctor_id"
    t.integer "specialty_id"
    t.index ["doctor_id"], name: "index_join_table_doctors_specialties_on_doctor_id"
    t.index ["specialty_id"], name: "index_join_table_doctors_specialties_on_specialty_id"
  end
